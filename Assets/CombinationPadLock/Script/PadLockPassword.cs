...
public class PadLockPassword : MonoBehaviour
{
    ...
    public void Password()
    {
        if (_moveRull._numberArray.SequenceEqual(_numberPassword))
        {
            ...
            GameObject.FindWithTag("FacePadLock").SetActive(false);
            GameObject.FindWithTag("PadLock").SetActive(false);
            SafeAnimation.SetBool("Open",true);
